...
public class testTicketPrice {
    /* Модуль 2 задание 1 1. Составьте тест-кейсы по аналогии с ручным тестированием и оформите их в виде автотестов JUnit для указанной ниже функции расчёта процента от стоимости билета при возврате. Опирайтесь в первую очередь на аналитику, примените привычные вам техники тест-дизайна. Напишите не менее пяти тестов.
